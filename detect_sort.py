'''
Author: Bappy Ahmed (modified for Streamlit/HuggingFace deployment)
...
from yolov5.utils.general import (check_img_size, check_requirements, check_imshow,
    non_max_suppression, apply_classifier, scale_coords, xyxy2xywh, strip_optimizer,
...
def detect(weights='yolov5s.pt',
    ...
    for frame_idx, (path, img, im0s, vid_cap) in enumerate(dataset):
        ...
        for i, det in enumerate(pred):
            ...
            if len(det):
                ...
                if save_txt and len(outputs) != 0:
                    for j, output in enumerate(outputs):
                        bbox_left, bbox_top, bbox_w, bbox_h, identity = \
                            output[0], output[1], output[2], output[3], output[-1]
            ...
            # ---- NO cv2.imshow in headless mode ----
...
if __name__ == '__main__':
    ...
    parser.add_argument('--view-img', action='store_true', help='show results (disabled in headless mode)')
